...
- **Recipes are read-only**: 3 seeded recipes; no creation/editing flow in the POC. — §5.4/§8.
...
| <decisions id="DEC-recipe-readonly" status="locked">DEC-recipe-readonly</decisions> | 3 seeded recipes are read-only in POC | §5.4/§8 | — Pending |
